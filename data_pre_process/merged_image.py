...
def merged_image(window_size, date_days):
    # target file
    f1 = open("D:\Academic\data_nvspl\SRCID_LAKE017_data.txt", 'w')
    # window_size = 10
    ...
    for i1 in range(date_days):
        ...
        for i2 in range(24):
            ...
            for i3 in range(int(3600 / window_size)):
                for i4 in range(window_size):
...
if __name__ == '__main__':
    window_size = 20
    date_days = 16
    merged_image(window_size, date_days)
